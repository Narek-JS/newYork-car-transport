...
import { IVehicleFormData, SetStepFunction, TypeOperableMethod, TypeShippingMethod, UpdateGeneralFormData, VahicleNode } from '@/model/form';
...
const FormVehicles: React.FC<IProps> = ({ setStep, updateGeneralFormData, initialValues }) => {
    ...
    return (
        <form className={classes.form} onSubmit={formik.handleSubmit}>
            <div className={classes.goBack} onClick={() => setStep(1)}>
                <GoBackFormIcon />
                <span>Edit</span>
            </div>
            ...
            <div className={classes.vehicles}>
                ...
                { formik.values.vehicle.map((vehicle, index) => {
                    ...
                    return (
                        <div key={Math.floor(Math.random() * 999999999999999999)} className={classes.vehicleList}>
            ...
            <div className={classes.seccondLine}>
                ...
                <div className={classes.wrapperCheckBoxesGroup}>
